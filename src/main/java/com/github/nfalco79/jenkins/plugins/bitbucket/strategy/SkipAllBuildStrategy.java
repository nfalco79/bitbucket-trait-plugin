...
/**
 * This strategy skip all index event. Only manual builds are allowed.
 * 
 * @author Nikolas Falco
 */
public class SkipAllBuildStrategy extends BranchBuildStrategy {

    @DataBoundConstructor
    public SkipAllBuildStrategy() {
    }
    ...
    public static class DescriptorImpl extends BranchBuildStrategyDescriptor {
        ...
        public String getDisplayName() {
            return Messages.SkipAllBuildStrategy_displayName();
        }
